...
class __TwigTemplate_0c5300c28667d482bbd699eef3b1feab7656a5119e14ad50684037e9c6506829 extends \Twig\Template
{
    private $source;
...
$context["log"], "priorityName", [], "any", false, false, false, 199) == "WARNING")) ? ("status-warning") : (""))))));
                ...
                echo "
                    <td class=\"font-normal\">";
                // line 219
                echo $context["helper"]->macro_render_log_message((isset($context["category"]) || array_key_exists("category", $context) ? $context["category"] : (function () { throw new RuntimeError('Variable "category" does not exist.', 219, $this->source); })()), twig_get_attribute($this->env, $this->source, $context["loop"], "index", [], "any", false, false, false, 219), $context["log"]);
                echo "</td>
                </tr>
            ";
                ++$context['loop']['index0'];
...
{% macro render_log_message(category, log_index, log) %}
    ...
    {% endif %}
{% endmacro %}
", "@WebProfiler/Collector/logger.html.twig", "/var/www/html/HomeSwichHome/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views/Collector/logger.html.twig");
    }
}
