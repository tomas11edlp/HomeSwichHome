...
class __TwigTemplate_7a7dd838b51b2e5a4cd337a8270b331ebfd1cfcff8ff34ba7a05b41503cbbf81 extends \Twig\Template
{
    ...
    <ul class=\"list-unstyled\">
        ...
        echo "\"><i class=\"fa fa-fw fa-home\"></i> Propiedades </a></li>
        <li><a href=\"";
        // line 4
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("subasta_index");
        echo "\"><i class=\"fas fa-donate\"></i> Subastas </a></li>
        ";
        // line 17
        echo "    </ul>
</div>";
    ...
    {
        return array (  53 => 17,  49 => 4,  45 => 3,  41 => 1,);
    }
    ...
    <ul class=\"list-unstyled\">
        <li><a href=\"{{path('propiedad_index')}}\"><i class=\"fa fa-fw fa-home\"></i> Propiedades </a></li>
        <li><a href=\"{{path('subasta_index')}}\"><i class=\"fas fa-donate\"></i> Subastas </a></li>
        {# <li><a href=\"{{path('estadoreserva_index')}}\"><i class=\"fas fa-donate\"></i> Estados Subasta </a></li>
        <li>
