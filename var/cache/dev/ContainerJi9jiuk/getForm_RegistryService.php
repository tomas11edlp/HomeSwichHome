...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(['AppBundle\\Form\\EstadoReservaType' => function () {
    return ${($_ = isset($this->services['AppBundle\\Form\\EstadoReservaType']) ? $this->services['AppBundle\\Form\\EstadoReservaType'] : ($this->services['AppBundle\\Form\\EstadoReservaType'] = new \AppBundle\Form\EstadoReservaType())) && false ?: '_'};
}, 'AppBundle\\Form\\EstadoSubastaType' => function () {
    return ${($_ = isset($this->services['AppBundle\\Form\\EstadoSubastaType']) ? $this->services['AppBundle\\Form\\EstadoSubastaType'] : ($this->services['AppBundle\\Form\\EstadoSubastaType'] = new \AppBundle\Form\EstadoSubastaType())) && false ?: '_'};
}, 'AppBundle\\Form\\Paginador\\FilterPropiedadType' => function () {
    return ${($_ = isset($this->services['AppBundle\\Form\\Paginador\\FilterPropiedadType']) ? $this->services['AppBundle\\Form\\Paginador\\FilterPropiedadType'] : ($this->services['AppBundle\\Form\\Paginador\\FilterPropiedadType'] = new \AppBundle\Form\Paginador\FilterPropiedadType())) && false ?: '_'};
}, 'AppBundle\\Form\\PropiedadType' => function () {
    return ${($_ = isset($this->services['AppBundle\\Form\\PropiedadType']) ? $this->services['AppBundle\\Form\\PropiedadType'] : ($this->services['AppBundle\\Form\\PropiedadType'] = new \AppBundle\Form\PropiedadType())) && false ?: '_'};
}, 'AppBundle\\Form\\SubastaType' => function () {
    return ${($_ = isset($this->services['AppBundle\\Form\\SubastaType']) ? $this->services['AppBundle\\Form\\SubastaType'] : ($this->services['AppBundle\\Form\\SubastaType'] = new \AppBundle\Form\SubastaType())) && false ?: '_'};
}, 'AppBundle\\Form\\UsuarioLoginType' => function () {
    return ${($_ = isset($this->services['AppBundle\\Form\\UsuarioLoginType']) ? $this->services['AppBundle\\Form\\UsuarioLoginType'] : ($this->services['AppBundle\\Form\\UsuarioLoginType'] = new \AppBundle\Form\UsuarioLoginType())) && false ?: '_'};
